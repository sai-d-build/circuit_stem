...
void main() {
  group('Interaction Performance Benchmarks', () {
    ...
    test('should handle rapid coordinate transformations efficiently', () {
      ...
      print(
          '1000 coordinate transformations took ${elapsedMs}ms (${elapsedMs / 1000}ms per transformation)');
    });
    ...
    test('should maintain performance with caching enabled', () {
      ...
      print(
          '300 cached transformations took ${elapsedMs}ms (${elapsedMs / 300}ms per transformation)');
    });
    ...
    test('should perform well under memory pressure', () {
      const context = CoordinateContext(
        gridDimensions: Size(50, 50), // Large grid
        cellSize: 20,
        scale: 1,
        panOffset: Offset.zero,
      ...
      print(
          '2500 transformations took ${elapsedMs}ms (${elapsedMs / 2500}ms per transformation)');
    });
    ...
    test('should handle concurrent validation requests efficiently', () {
      ...
      expect(elapsedMs, lessThan(100));
      print(
          '500 validation requests took ${elapsedMs}ms (${elapsedMs / 500}ms per validation)');
    });
    ...
    test('should maintain performance with boundary checking', () {
      ...
      for (var x = -50; x < 600; x += 25) {
        for (var y = -50; y < 600; y += 25) {
      ...
      print(
          'Boundary checking for ${((600 + 50) / 25) * ((600 + 50) / 25)} positions took ${elapsedMs}ms');
    });
