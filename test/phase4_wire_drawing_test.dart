...
void main() {
  group('Phase 4.4: Wire Drawing from Component Ports Tests', () {
    testWidgets('long press on component starts wire drawing mode',
        (tester) async {
    ...
    testWidgets('wire connects when dragging to another component',
        (tester) async {
    ...
    testWidgets('wire drawing cancels when tapping empty space',
        (tester) async {
