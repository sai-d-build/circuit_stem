...
void main() {
  group('Wire Interaction Tests', () {
    ...
    testWidgets('TC-L2-01: Tapping a rotatable wire changes its rotation', (tester) async {
      // ARRANGE
      ...
      expect(finalWire.rotation, equals(newRotation), reason: 'Wire should have rotated by 90 degrees');
    });
  });
}
